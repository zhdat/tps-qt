...
#include <memory>
#include "../../1_tp/include/ColorWidget.h"
...
QT_MOC_LITERAL(6, 32, 11) // "changeColor"
...
void ColorWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ColorWidget::*)(int , int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ColorWidget::colorChanged)) {
                *result = 0;
                return;
            }
        }
